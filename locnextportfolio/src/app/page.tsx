    ...
    <div className="flex flex-col items-center justify-between">
      <section
        ...
        <div className='flex flex-col gap-8 text-center lg:text-left'>
          ...
          <p className='font-mono text-green-600 font-medium md:text-lg xl:text-xl'>A passionate computer programmer</p>
      ...
      <section
        ...
        <p className='text-gray-300 pt-20 md:text-lg xl:text-xl'>I am a programmer specializing in building
        ...
        <p className='text-gray-300 pt-8 md:text-lg xl:text-xl'>My commitment to promoting creativity is demonstrated by my
